...
const en: Translations = {
  ...
  contact: {
    ...
    form: {
      ...
      inquiryPlaceholder: "Select a topic",
      inquiryOptions: ["Product Inquiry", "Distributor Partnership", "Verification Issue", "Other"],
      message: "Message",
      messagePlaceholder: "Please describe your inquiry in detail...",
      privacy: "I have read and agree to the Privacy Policy",
      privacyTitle: "Privacy Policy",
      privacyContent: "We collect your name and email address solely for the purpose of responding to your inquiry. Your information is securely stored for a retention period of 1 year. You may request deletion of your personal information at any time.",
      submit: "Send Message",

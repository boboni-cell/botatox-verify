...
export const categoryLabels: Record<Category, { en: string; zh: string; ko: string }> = {
  1: { en: "Botulinum Toxin", zh: "肉毒素", ko: "보툴리눔 톡신" },
  2: { en: "Dermal Fillers", zh: "填充剂", ko: "필러" },
  3: { en: "Skin Care", zh: "皮肤管理", ko: "스킨케어" },
};
...
export const products: Product[] = [
  // ==================== 自有品牌 - 肉毒素 (1) ====================
  {
    ...
    descKo: "프리미엄 A형 보툴리눔 톡신. 미간 주름, 눈가 주름 및 이마 주름 치료를 위한 고순도 포뮬러로 자연스러운 결과를 제공합니다.",
  },

  {
    ...
    descKo: "Botulinum toxin type A for facial wrinkle improvement. Reliable quality with consistent results.",
  },

  {
    ...
    descKo: "Botulinum toxin type A for aesthetic treatments. Trusted formulation for professional use.",
  },

  {
    ...
    descKo: "Korean botulinum toxin type A. High-quality formulation for various aesthetic indications.",
  },
  ...
  // ==================== 自有品牌 - 填充剂 (2) ====================
  {
    ...
    descKo: "Premium hyaluronic acid dermal filler. Advanced cross-linking technology for long-lasting volume restoration and wrinkle correction.",
  },

  {
    ...
    descKo: "Collagen-enhanced dermal filler combining the benefits of collagen and HA for comprehensive skin rejuvenation.",
  },

  {
    ...
    descKo: "Advanced HA filler series with varying cross-linking densities for customized facial volumizing and contouring treatments.",
  },

  {
    ...
    descKo: "Specialized lip enhancement filler. Designed specifically for natural-looking lip volumizing and contour definition.",
  },
  ...
  // ==================== 自有品牌 - 皮肤管理 (3) ====================
  {
    ...
    descKo: "Advanced exosome-based skin rejuvenation treatment. Promotes cellular regeneration for improved skin texture and elasticity.",
  },
  ...
  // ==================== 代理品牌 - 肉毒素 (1) ====================
  {
    ...
    descKo: "Botulinum toxin type A 100U. Widely used in aesthetic clinics for wrinkle reduction and facial contouring.",
  },

  {
    ...
    descKo: "Botulinum toxin type A 200U. Higher dosage for broader treatment areas and deeper muscle relaxation.",
  },

  {
    ...
    descKo: "Botulinum toxin type A 100U. Established brand with proven efficacy for aesthetic treatments.",
  },

  {
    ...
    descKo: "Botulinum toxin type A 200U. Higher potency for advanced aesthetic procedures.",
  },
  ...
  // ==================== 代理品牌 - 填充剂 (2) ====================
  {
    ...
    descKo: "4D lifting filler for comprehensive facial rejuvenation. Multi-dimensional approach to volume restoration and skin tightening.",
  },

  {
    ...
    descKo: "Specialized filler for neck wrinkle treatment. Designed to address horizontal neck lines effectively.",
  },

  {
    ...
    descKo: "Advanced HA dermal filler with excellent viscoelastic properties for natural facial volumizing.",
  },

  {
    ...
    descKo: "Hyaluronic acid dermal filler with high elasticity for dynamic facial areas requiring flexibility.",
  },

  {
    ...
    descKo: "Well-established HA filler brand from LG Chem. Trusted by practitioners worldwide for safe and effective results.",
  },

  {
    ...
    descKo: "High-density HA filler with excellent lifting capacity. Ideal for deep tissue volumizing and facial sculpting.",
  },

  {
    ...
    descKo: "HA filler manufactured with advanced SHAPE technology for minimal swelling and long-lasting results.",
  },

  {
    ...
    descKo: "Premium HA filler designed for natural-looking volume restoration and wrinkle correction.",
  },

  {
    ...
    descKo: "Innovative HA filler with excellent tissue integration for smooth and natural aesthetic outcomes.",
  },

  {
    ...
    descKo: "Next-generation dermal filler promoting tissue regeneration alongside immediate volumizing effects.",
  },

  {
    ...
    descKo: "Hyaluronidase enzyme for dissolving HA fillers. Essential tool for filler correction and reversal procedures.",
  },

  {
    ...
    descKo: "Lipolytic solution for localized fat reduction. Non-surgical approach to body contouring and fat dissolution.",
  },

  {
    ...
    descKo: "Hydrating skin booster injection for deep moisturization and skin radiance enhancement.",
  },
  ...
  // ==================== 代理品牌 - 皮肤管理 (3) ====================
  {
    ...
    descKo: "Exosome-infused topical cream for daily skin regeneration and anti-aging care.",
  },

  {
    ...
    descKo: "PDO absorbable threads for non-surgical facial lifting. Stimulates collagen production for gradual skin tightening.",
  },

  {
    ...
    descKo: "Advanced skin lifting treatment device for non-invasive facial and body contouring.",
  },

  {
    ...
    descZh:
      "微波紧肤提拉疗程，全面焕活肌肤。",
    descKo: "Microwave-based skin tightening and lifting treatment course for comprehensive rejuvenation.",
  },

  {
    ...
    descKo: "Polynucleotide (PN) based skin healer. Promotes tissue regeneration for improved skin quality and elasticity.",
  },

  {
    ...
    descKo: "Specialized PN formulation for scar and acne scar treatment with tissue remodeling properties.",
  },

  {
    ...
    descKo: "PN skin booster for overall skin rejuvenation. Improves hydration, elasticity, and skin barrier function.",
  },

  {
    ...
    descKo: "Prefilled sodium hyaluronate injection for convenient and precise skin hydration treatments.",
  },

  {
    ...
    descKo: "Exosome-based skin booster for advanced cellular-level skin rejuvenation and repair.",
  },
...
export const productImages: Record<string, string[]> = {
  ...
  "jtox-100u": [`${R2}/tox/jtox3.PNG`, `${R2}/tox/JTOX2.png`],
  "rollietox-100u": [`${R2}/tox/Rollie.JPG`],
  "ktox-100u": [`${R2}/tox/ktox3.JPG`, `${R2}/tox/ktox2.PNG`],
  "masetox-100u": [`${R2}/tox/masetox2.png`, `${R2}/tox/MASETOX.png`, `${R2}/tox/masetox2_3.PNG`],
  ...
  "botulax-200u": [`${R2}/tox/botatolax.png`, `${R2}/tox/botulax200u2.png`],
};

...
const contacts: ContactItem[] = [
  ...
  },
  {
    ...
    label: "Address",
    value:
      "#Gasan Publik A08-0816, 60-26, Gasan-Dong, Geumcheon-Gu, Seoul, Korea",
  },
];
          ...
          {contacts.map((item) => {
            const content = (
              <div className="flex items-center gap-4 rounded-xl bg-white px-5 py-4 shadow-sm shadow-gray-200/50 transition-colors hover:bg-gray-50/80">
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-lg bg-[#EBF4FF] text-[#2b6cb0]">
                  {item.icon}
                </div>

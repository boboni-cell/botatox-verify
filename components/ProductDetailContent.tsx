        ...
        <div className="mx-auto max-w-4xl">
          ...
          {product.id === "botatox-100u" && (
            <section className="mt-10">
              ...
              <div className="mt-4 grid gap-6 md:grid-cols-[60%_1fr]">
                {/* Factory Image */}
                <img
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="rounded-xl bg-white p-4 shadow-[0_2px_12px_rgba(26,54,93,0.06)] border border-[rgba(26,54,93,0.06)]">
                    <div className="flex items-start gap-2 text-xs text-gray-500">
                      ...
                      <span className="break-words">{pd.facility.address}</span>
                    </div>
                    <div className="mt-3 grid gap-2 sm:grid-cols-2">
                      <a href="tel:033-344-3700" className="flex items-center gap-2 rounded-lg bg-[#EBF4FF] px-3 py-2 text-xs text-navy hover:bg-[#dbeafe]">
                        <svg className="h-4 w-4 text-[#3B9FDA]" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.5}><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 01-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 00-1.091-.852H4.5A2.25 2.25 0 002.25 4.5v2.25z" /></svg>
                        {pd.facility.tel}
                      </a>
                      <a href="mailto:genetox@genetox.co.kr" className="flex items-center gap-2 rounded-lg bg-[#EBF4FF] px-3 py-2 text-xs text-navy hover:bg-[#dbeafe]">

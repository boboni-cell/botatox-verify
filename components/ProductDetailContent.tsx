              ...
              <div className="mt-4 grid gap-4 md:grid-cols-2">
                ...
                <div className="flex flex-col gap-3">
                  <iframe
                    ...
                    className="h-[220px] w-full rounded-xl md:flex-1 md:h-auto"
                  ...
                  <div className="rounded-xl bg-white p-4 shadow-[0_2px_12px_rgba(26,54,93,0.06)] border border-[rgba(26,54,93,0.06)]">
                    ...
                    <div className="mt-3 flex flex-col gap-2">
                      ...
                      <a href={`mailto:${pd.facility.mail}`} className="flex items-center gap-2 rounded-lg bg-[#EBF4FF] px-3 py-2 text-[13px] text-navy hover:bg-[#dbeafe]">

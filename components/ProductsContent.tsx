        ...
        <div className="flex aspect-square items-center justify-center bg-white p-5">
          {productImages[product.id] ? (
            <div className="relative h-full w-full">
              <Image src={productImages[product.id][0]} alt={product.nameEn} fill unoptimized className="object-contain p-3" />
            </div>
          ) : (
  ...
  return (
    ...
    >
      <div className="flex aspect-square items-center justify-center bg-white p-5">
        {productImages[product.id] ? (
          <div className="relative h-full w-full">
            <Image src={productImages[product.id][0]} alt={product.nameEn} fill unoptimized className="object-contain" />
          </div>
        ) : (

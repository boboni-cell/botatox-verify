          ...
          <div className="rounded-2xl bg-white px-6 py-6 shadow-sm shadow-gray-200/50 sm:px-8">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-4 flex flex-col items-center gap-3 md:flex-row md:items-end md:gap-4">
                  <img
                    src="https://pub-8c4bce25bb3f4de4a3bf5925c0af5425.r2.dev/hiddentag.png"
                    alt="HiddenTag"
                    className="w-full max-w-[160px] rounded-xl md:max-w-[180px]"
                  />
                  <div className="flex items-center gap-3 text-[#3B9FDA] md:flex-row">
                    <svg
                      className="h-10 w-10 rotate-90 md:h-12 md:w-12 md:rotate-0"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                      strokeWidth={2}
                    ...
                    <span className="text-base font-bold md:text-lg">{v.scanHint}</span>
                  </div>
                </div>

      ...
      <main className="flex-1 px-4 pt-28 pb-8">
        <div className="mx-auto max-w-4xl">
          ...
          <section className="mt-12">
            ...
            <div className="mx-auto mt-6 grid max-w-[700px] gap-4 sm:grid-cols-2">
              {contacts.map((c) => {
                const card = (
                  <div className="group rounded-xl bg-white px-5 py-6 text-center shadow-[0_2px_12px_rgba(26,54,93,0.06)] border border-[rgba(26,54,93,0.06)] transition-all duration-200 hover:-translate-y-0.5 hover:shadow-[0_4px_20px_rgba(26,54,93,0.10)]">
                    <div className="mx-auto flex h-10 w-10 items-center justify-center rounded-full bg-[#EBF4FF] text-[#3B9FDA]">
                      {c.label === "Tel" && (
